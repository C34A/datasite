...
app.get("/response", async function (req, res) {
  ...
  const confusion = strtobool(req.query[SENT_NAMES[6]] as string);
  const curiosity = strtobool(req.query[SENT_NAMES[7]] as string);
  const desire = strtobool(req.query[SENT_NAMES[8]] as string);
  const disappointment = strtobool(req.query[SENT_NAMES[9]] as string);
  const disapproval = strtobool(req.query[SENT_NAMES[10]] as string);
  const disgust = strtobool(req.query[SENT_NAMES[11]] as string);
  const embarrassment = strtobool(req.query[SENT_NAMES[12]] as string);
  const excitement = strtobool(req.query[SENT_NAMES[13]] as string);
  const fear = strtobool(req.query[SENT_NAMES[14]] as string);
  const gratitude = strtobool(req.query[SENT_NAMES[15]] as string);
  const grief = strtobool(req.query[SENT_NAMES[16]] as string);
  const joy = strtobool(req.query[SENT_NAMES[17]] as string);
  const love = strtobool(req.query[SENT_NAMES[18]] as string);
  const nervousness = strtobool(req.query[SENT_NAMES[19]] as string);
  const optimism = strtobool(req.query[SENT_NAMES[20]] as string);
  const pride = strtobool(req.query[SENT_NAMES[21]] as string);
  const realization = strtobool(req.query[SENT_NAMES[22]] as string);
  const relief = strtobool(req.query[SENT_NAMES[23]] as string);
  const remorse = strtobool(req.query[SENT_NAMES[24]] as string);
  const sadness = strtobool(req.query[SENT_NAMES[25]] as string);
  const surprise = strtobool(req.query[SENT_NAMES[26]] as string);
  const neutral = strtobool(req.query[SENT_NAMES[27]] as string);
  const bad_string = strtobool(req.query[SENT_NAMES[28]] as string);
